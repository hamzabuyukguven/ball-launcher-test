  ...
  <model
    ...
    <link name="ball_link">
      ...
      <visual name="ball_visual">
        <!-- Silindirin varsayılan ekseni Z'dir.
             90 derece döndürülerek namlu ekseni olan X'e alınır. -->
        ...
        <material>
          <ambient>0.30 0.18 0.035 1.0</ambient>
          <diffuse>0.70 0.42 0.07 1.0</diffuse>
          <specular>0.65 0.55 0.25 1.0</specular>
