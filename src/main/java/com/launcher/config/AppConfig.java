...
public final class AppConfig {
    ...
    public double getMuzzleVelocity() {
        return doubleValue("control.muzzle.velocity", "MUZZLE_VELOCITY", 100.0);
    }
    ...
    public double getMaxPanRate() {
        return doubleValue("control.max.pan.rate", "MAX_PAN_RATE", 0.20);
    }

    public double getMaxTiltRate() {
        return doubleValue("control.max.tilt.rate", "MAX_TILT_RATE", 0.10);
    }
